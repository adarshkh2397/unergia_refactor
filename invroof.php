...
<div class="navbar">
  ...
  <a href="index_investor.html">Home</a>
  <a href="#news">News</a>  
</div>   

<!--div class="hero hero--offering-1">-->
  <div class="lonely text-center">
  <h1 class="building" id="building"></h1>
   <!--<h2 class="building" >Hello <?php echo $_SESSION['name']; ?></h2>-->
...
<h3 style="text-align: left; ">Unergia Dashboard</h3>
  <div class="item1" id='item1'>FusionCharts will load here.</div>
  <div class="item2" id='item2'>FusionCharts will load here.</div>
...
<div style="color:#fff" >
<!--<h1 STYLE="text-indent: 0.5in; margin-bottom: 0in; margin-left: -40px"></h1>
<P STYLE="margin-bottom: 0in"><BR></P>
<P STYLE="margin-bottom: 0in">    	</P>
<P STYLE="margin-bottom: 0in">                                   
<FONT SIZE=6><FONT COLOR="#1155cc">Project Cost</FONT><IMG SRC="calendaricon.png" NAME="image6.png" HSPACE= 12 WIDTH=27 HEIGHT=32><FONT SIZE=5><B>:
</B></FONT><FONT SIZE=5 id="elec1"></font><P STYLE="margin-bottom: 0in">    	
</P><FONT SIZE=6><FONT COLOR="#1155cc">Project Status</FONT><IMG SRC="walleticon.png" NAME="image2.png" HSPACE= 12 WIDTH=31 HEIGHT=31></FONT><FONT SIZE=5><B>:
</B></FONT><FONT SIZE=5 id="elec2"></FONT><P STYLE="margin-bottom: 0in">    	</P> 
</P><FONT SIZE=6><FONT COLOR="#1155cc">Expected IRR</FONT><IMG SRC="walleticon.png" NAME="image2.png" HSPACE= 12 WIDTH=31 HEIGHT=31></FONT><FONT SIZE=5><B>:
</B></FONT><FONT SIZE=5 id="elec2"></FONT><P STYLE="margin-bottom: 0in">    	</P> 
...
<center>
<div style="color:#fff">
<h1 STYLE="text-indent: 0.5in; margin-bottom: 0in; font-size: 150%";>PROJECT SPECIFICATIONS</h1></font>

</P>
<P STYLE="margin-bottom: 0in">    	</P>

<div class="row unrelated-bottom ng-scope">
  <div class="col-md-6">
    <div class="list-group">
      <div class="list-group__item">
        <dt>Size of Shade Free Space</dt>
        <dd class="ng-binding" id="nmt"></dd>
      </div>
      <div class="list-group__item">
        <dt>Solar Panel Manufacturer</dt>
        <!-- ngIf: offering.id != 5 --><dd ng-if="offering.id != 5" class="ng-scope" id="wos"></dd><!-- end ngIf: offering.id != 5 -->
        <!-- ngIf: offering.id == 5 -->
      </div>
      <div class="list-group__item">
        <dt>Length Of PPA</dt>
...
<br><br>
  ...
  <!--<div id="abc" style="align-items: center">
  <p style="float: left; width: 40%">This DOCUMENT press to download</p>
  <a href="test.docx" download="proposal">
  <img style="float: right;" src="downloadbutton.png" alt="W3Schools" width="50" height="50"></a>
  </div>
 -->

 
  <!--<a href="https://www.ipcamlive.com/" id="abc" style="position:relative"><button>Camera</button></a><br><br>
<a href="https://drive.google.com/open?id=1wJdByEOe8ufIJ0J6JTH28B3pb7PdkDEg" id="abc"><button>Download Documents</button></a>
-->
...
console.log("THE FULL THING   "+queryString);
queryString = queryString.substring(1);
console.log("SUBSTRING    "+queryString);
...
ref.on("value", function(snapshot){ 
  ...
  var doclink1=data.Documents.Link;
  var doclink=data.Documents.Link;

  $("#ssfs").html(data.SizeOfShadeFreeSpace)
	$("#caeb").html(data.CurrentAvgElectricityBill)
	$("#pusp").html(data.ProjectedUnitsOfSolarProduced)
	$("#paeb").html(data.ProjectedAvgElectricityBill)
	$("#tnm").html(data.TotalNoOfMeters)
	$("#sps").html(data.SolarPanelSize)
	$("#tos").html(data.TypeOfStructure)
	$("#spm").html(data.SolarPanelManufacturer)
	$("#iu").html(data.InverterUsed)
	$("#ek").html(data.EarthingKit)
	$("#ik").html(data.InstallationKit)
	$("#lop").html(data.LengthOfPPA)
	$("#apspho").html(data.AfterPPASolarPanelHandedOver)
	$("#sd").html(data.SecurityDeposit)
	$("#sapm").html(data.SavingsPerMonth)
	$("#nmt").html(data.NetMeteringTariff)
	$("#solp").html(data.SavingsOverLengthOfProject)
	$("#wos").html(data.WarrantyOnSystem)
	$("#wom").html(data.WarrantyOnModules)
	$("#glsp").html(data.GeneralLifespanOfSolarPanel)
	$("#info").html(data.Info)
	$("#building").html(data.Building)
	$("#elec1").html(data.electricity1);
	$("#elec2").html(data.electricity2);
	$("#elec3").html(data.electricity3);
	$("#elec4").html(data.electricity4);
  $("#invimage").html(data.InvPageImage);
	
});


var url=window.location.search;
      var miniurl= url.substring(url.lastIndexOf("=") + 1);
      miniurl+="/data3";
function getData1(callbackIN) {
      var ref = firebase.database().ref("Project1/data3");
